$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-ExecutionPolicy Bypass -WindowStyle Hidden -File `\"D:\Lens\Dashboard\hourly_update_and_publish.ps1`\""
